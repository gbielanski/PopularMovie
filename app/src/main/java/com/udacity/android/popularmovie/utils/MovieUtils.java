...
public class MovieUtils {
    ...
    public static final String THE_MOST_POPULAR_URL_STRING = "https://api.themoviedb.org/3/movie/popular";
    public static final String THE_HIGHEST_RATED_URL_STRING = "https://api.themoviedb.org/3/movie/top_rated";
    public static final String THE_MOVIE_DB_URL_STRING = "https://api.themoviedb.org/3/movie/";
    public static final String THE_MOVIE_TRAILERS_URL_STRING = "videos";
    public static final String THE_MOVIE_REVIEWS_URL_STRING = "reviews";
    public static final String API_KEY = "api_key";
    public static final String PATH = "http://image.tmdb.org/t/p/";
